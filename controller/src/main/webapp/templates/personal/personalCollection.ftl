    ...
    <div class="fly-panel fly-panel-user" pad20>
        ...
        <div class="layui-tab layui-tab-brief" lay-filter="user">
            <ul class="layui-tab-title" >
                <li  ><a href="/role/post">我发的帖子 </a></li>
                <li class="layui-this">我收藏的帖子(<span>${pageInfo.total}</span>)</li>
            </ul>
                ...
                <div class="layui-tab-item layui-show">
                    <ul class="mine-view jie-row">
                        ...
                        <#list pageInfo.list as infos>
                            <li>
                                <a class="jie-title" href="/post/${infos.post_id}" target="_blank">${infos.post_title}</a>
                    ...
                    <script type="text/javascript">
                        var GG = {
                            "kk":function(mm){
                                //链接地址
                                window.location.href="/role/postCollection?pn="+mm;
                            }
                        }
